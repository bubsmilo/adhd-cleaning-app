...
const RC={"Kitchen":C.orange,"Living Room":C.teal,"Bathroom":C.blue,"Bedroom":C.coral,"Upstairs":C.yellow,"Downstairs":"#B39DDB","Garage":"#90A4AE","Outdoor":"#66BB6A","General":C.greyText};
...
const QUARTERLY_DATA={
  "Jan / Mar":{color:"#F48FB1",emoji:"❄️",items:QUARTERLY_ITEMS},
  "Apr / Jun":{color:"#A8D8A8",emoji:"🌸",items:QUARTERLY_ITEMS},
  "Jul / Sep":{color:C.yellow,emoji:"☀️",items:QUARTERLY_ITEMS},
  "Oct / Dec":{color:"#FFAB40",emoji:"🍂",items:QUARTERLY_ITEMS},
};
...
const YEARLY_DATA={
  January:{color:"#B39DDB",emoji:"🗓️",items:["Deep clean kitchen appliances","Declutter and organize closets","Clean windows and blinds","Dust light fixtures & ceiling fans","Replace air filters","Vacuum upholstery and rugs","Wash windows inside & out","Clean kitchen cabinets & appliances","Check plumbing for leaks","Dust and polish woodwork","Clean outdoor furniture","Sweep, Clean, Mop Floors"]},
  February:{color:"#F48FB1",emoji:"🗓️",items:["Scrub bathroom tiles & fixtures","Launder bedding and linens","Dust and polish furniture","Clean baseboards and trim","Organize garage or store areas","Sweep, Clean, Mop Floors","Organize and clean closets","Dust and polish wood furniture","Clean ceiling fans & light fixtures","Clean oven & range hood","Sweep, Clean, Mop Floors"]},
  March:{color:"#A5D6A7",emoji:"🗓️",items:["Dust curtains & clean air vents","Wipe down electronics","Sweep outdoor areas & trim bushes","Deep clean carpets or rugs","Declutter and organize pantry","Sweep, Clean, Mop Floors"]},
  April:{color:"#80DEEA",emoji:"🗓️",items:["Wash windows inside & out","Clean kitchen cabinets & appliances","Check plumbing for leaks","Dust and polish woodwork","Clean outdoor furniture","Dust light fixtures & ceiling fans","Replace air filters","Vacuum upholstery and rugs"]},
  May:{color:"#A8D8A8",emoji:"🗓️",items:["Organize and clean closets","Sweep, Clean, Mop Floors","Organize garage or store areas","Clean baseboards and trim","Scrub grill, outdoor equipment","Deep clean refrigerator","Spot clean walls touchup paint","Vacuum upholstered furniture"]},
  June:{color:C.yellow,emoji:"🗓️",items:["Sweep, Clean, Mop Floors","Declutter and organize pantry","Deep clean carpets or rugs","Sweep outdoor areas & trim bushes","Scrub grill, outdoor equipment"]},
  July:{color:C.orange,emoji:"🗓️",items:["Declutter tools & storage items","Vacuum and rotate mattresses","Scrub and seal tile grout in bathrooms and kitchens","Scrub grill grates and replace propane if needed","Clean outside windows & screens","Sweep and apply deck treatment as necessary","Sweep, Clean, Mop Floors","Clean outdoor furniture"]},
  August:{color:"#FFCC80",emoji:"🗓️",items:["Scrub showers, toilets & sinks","Organize & dust books / shelves","Treat leather sofas and chairs","Remove dust and debris from vents","Organize files & shred unnecessary documents","Wipe down frequently touched surfaces"]},
  September:{color:"#EF9A9A",emoji:"🗓️",items:["Clean fireplace and chimney","Dust and Clean Blinds","Clean Washing Machine","Remove cobwebs & dust from high corners","Arrange tools and equipment for easy access","Sweep porch and clean door & doormat"]},
  October:{color:"#FFAB40",emoji:"🗓️",items:["Clean & Organize Kitchen Pantry","Dust and Clean Electronics","Shine refrigerator & dishwasher","Clean Light Fixtures","Clean Gutters and Downspouts","Dust and Clean Ceiling Fans","Deep Clean Oven","Vacuum-Clean Rugs and Carpets"]},
  November:{color:"#B0BEC5",emoji:"🗓️",items:["Clean Gutters and Downspouts","Dust and Clean Ceiling Fans","Deep Clean Oven","Vacuum-Clean Rugs and Carpets"]},
  December:{color:"#EF9A9A",emoji:"🗓️",items:["Holiday Cleaning","Wipe down holiday lights","Prepare fireplace for holiday use","Clean & refresh entryway mats"]},
};

const SPEED_CLEAN_TIME_DATA={
  "5 Minutes":{color:"#A8D8A8",emoji:"⚡",items:["Pick up & put away items","Wipe Kitchen counters","Load/unload dishwasher","Make Bed","Wipe down Bathroom surfaces/toilet seat"]},
  "10–15 Minutes":{color:C.teal,emoji:"⏱️",items:["Quickly rinse & load any dirty dishes into the dishwasher","Spot-clean the floor around high-traffic areas","Scrub and sanitize the toilet quickly","Clean sink and wipe down bathroom countertops","Make the bed and straighten up pillows","Quickly tidy up any clothes or items lying around","Dust furniture surfaces including coffee tables & shelves","Quickly vacuum or sweep high-traffic areas"]},
  "20 Minutes":{color:C.blue,emoji:"🕐",items:["Quickly wipe down kitchen countertops & appliances","Spot-clean the floor","Do dishes","Clean bathroom sink, toilet, & mirror quickly","Wipe down bathroom surfaces & fixtures","Make the bed","Dust visible areas and quick tidy-up","Dust Living room surfaces & electronics","Declutter as needed"]},
  "30 Minutes":{color:C.yellow,emoji:"🕧",items:["Quickly wipe down kitchen countertops & appliances","Sweep or spot-clean Kitchen floor","Do Dishes","Wipe down bathroom surfaces & fixtures","Make the bed and straighten surfaces","Dust furniture & vacuum/sweep the floor","Dust living room furniture and electronics","Clean all tables"]},
  "45 Minutes":{color:C.orange,emoji:"🕒",items:["Clean Kitchen appliances","Do dishes","Wipe down kitchen cabinets & surfaces","Scrub Toilet & Clean Shower/tub","Make the bed","Change bedlinens & Dust surfaces","Dust living room furniture","Vacuum Living room"]},
  "60 Minutes":{color:C.coral,emoji:"🕕",items:["Wipe Kitchen surfaces & clean appliances","Sweep or vacuum the floor","Do dishes","Clean sink, toilet, and bathtub/shower","Make the bed and tidy up surfaces","Dust furniture","Vacuum/sweep living room floor","Arrange Seating","Empty trash bins throughout the house","Straighten up pillows and throws","Replace towels if needed","Make the Bed"]},
  "90 Minutes":{color:"#9B8EC4",emoji:"🕘",items:["Clean kitchen countertops, sink, & appliances","Wipe down Kitchen cabinet fronts","Sweep and mop Kitchen floor","Do dishes","Clean bathroom sink, countertop, and mirror","Scrub toilet and bathtub/shower","Replace towels if needed","Vacuum or sweep Bedroom floor","Dust Living room furniture & electronics","Vacuum or sweep Living room floor","Straighten up pillows and throws","Do a laundry load"]},
};

const SPEED_CLEAN_ROOM_DATA={
  "Gather Supplies":{color:C.greyText,emoji:"🧴",items:["All-purpose cleaner or multi-surface cleaner","Disinfectant spray or wipes","Glass cleaner","Microfiber cleaning cloths or paper towels","Broom, vacuum cleaner, dust pan","Mop & bucket, scrubbing sponge","Trash bags, toilet bowl cleaner and brush"]},
  Kitchen:{color:C.orange,emoji:"🍳",items:["Pick up & put away items that don't belong","Load dishwasher","Put dirty dishes in sink","Manually wash dishes as needed","Disinfect and wipe all counters","Wipe Exteriors of all Appliances (fridge, microwave)","Wipe down Stove tops","Clean sink","Sweep floor","Empty trash","Spot-clean cabinet doors","Spot clean all walls","Take out trash & Recycling","Clear Dining room table"]},
  "Dining Room":{color:"#FFCC80",emoji:"🪑",items:["Clear table","Dust surfaces","Sweep or vacuum floor","Straighten chairs","Spot-clean windows","Arrange centerpieces"]},
  Bathroom:{color:C.blue,emoji:"🚿",items:["Pick up clutter","Wipe countertop","Clean Mirrors","Wipe sink and faucet","Clean toilet seat and rim","Clean & Disinfect toilet Bowl","Wipe down toilet bowl & surrounding surface","Change towels","Empty Trash can","Sweep Floor","Replace toilet paper","Spot clean Floor stains"]},
  Bedrooms:{color:C.coral,emoji:"🛏️",items:["Pick up & put away items","Make the Bed","Open curtains","Pick up clothes","Wipe bedside table","Dust all surfaces","Vacuum floor","Wipe mirrors","Clear clutter from dresser/night stand"]},
  "Living Room":{color:C.teal,emoji:"🛋️",items:["Pick up & put away items/trash","Fluff pillows","Fold blankets","Straighten magazines","Wipe coffee table","Dust TV and surfaces","Wipe remote controls","Dust all surfaces","Clean & Organize desk area","Wipe down furniture, table & chair","Shake out rugs","Vacuum Floor"]},
  ...
  Everywhere:{color:"#9B8EC4",emoji:"🏠",items:["Pick up clutter","Vacuum carpet, Rugs & other areas","Quickly mop floors","Sweep floor","Clean Mirror & glass surfaces","Quickly empty all trash bins","Wipe all tables & Furniture"]},
};
...
function Stepper({value,onChange,accent}){return(<div style={{display:"flex",alignItems:"center",gap:16}}><button type="button" onClick={()=>onChange(Math.max(1,value-5))} style={{width:46,height:46,borderRadius:"50%",border:`2.5px solid ${accent}`,background:C.white,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={accent} strokeWidth="3.5" strokeLinecap="round"><line x1="5" y1="12" x2="19" y2="12"/></svg></button><span style={{fontSize:28,fontWeight:800,color:C.dark,minWidth:50,textAlign:"center"}}>{value}</span><button type="button" onClick={()=>onChange(value+5)} style={{width:46,height:46,borderRadius:"50%",border:`2.5px solid ${accent}`,background:C.white,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={accent} strokeWidth="3.5" strokeLinecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button></div>);}
...
function HomeScreen({tasks,setTasks,setSubScreen,setEditId}){
    ...
    return(
      <div key={label} style={{marginBottom:12}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6,paddingLeft:2}}>
          <span style={{fontSize:11,fontWeight:700,color:catColor[label],letterSpacing:1}}>{label.toUpperCase()}</span>
  ...
  return(<div style={{paddingBottom:80}}><div style={{padding:"20px 20px 8px",display:"flex",alignItems:"center",justifyContent:"center",gap:12}}>
      <img src="/icon.png" alt="" style={{width:135,height:135,flexShrink:0,objectFit:"contain",border:"none",background:"transparent"}} onError={e=>e.target.style.display="none"}/>
  ...
  <div style={{margin:"12px 16px",background:C.white,borderRadius:20,padding:"18px 20px",boxShadow:"0 2px 12px rgba(0,0,0,0.07)"}}><div style={{fontSize:11,fontWeight:700,color:C.coral,letterSpacing:1,marginBottom:12}}>TODAY'S PROGRESS</div><ProgressBar pct={pct} done={done} total={total} minsDone={minsDone} accent={C.blue} accentEnd="#6ab8c8" pctColor={C.orange} clockColor={C.teal}/></div>
  <div style={{margin:"0 16px 12px"}}>
    <div style={{fontSize:11,fontWeight:700,color:C.dark,letterSpacing:1,marginBottom:10}}>TODAY'S TASKS</div>
    {total===0?<div style={{background:C.white,borderRadius:20,boxShadow:"0 2px 12px rgba(0,0,0,0.07)",padding:"24px 16px",textAlign:"center",color:C.greyText,fontSize:14}}>No tasks scheduled for today. Add one!</div>:<div>{renderSection("Daily",dailyTasks)}{renderSection("Weekly",weeklyTasks)}{renderSection("Monthly",monthlyTasks)}</div>}
  </div>
  <div style={{margin:"0 16px"}}><div style={{fontSize:11,fontWeight:700,color:C.dark,letterSpacing:1,marginBottom:10}}>QUICK ACTIONS</div><div style={{display:"flex",gap:10}}><button type="button" onClick={()=>setSubScreen("haveTime")} style={{flex:1,background:"#E8F7F2",border:"2.5px solid #A8D9C8",borderRadius:20,padding:"18px 8px",cursor:"pointer",fontFamily:"inherit",display:"flex",flexDirection:"column",alignItems:"center",gap:8}}><svg width="38" height="38" viewBox="0 0 24 24" fill="none" stroke={C.teal} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg><div style={{fontSize:13,fontWeight:700,color:C.teal}}>I Have Time</div></button><button type="button" onClick={()=>setSubScreen("randomChore")} style={{flex:1,background:"#FEF3E2",border:"2.5px solid #F0C888",borderRadius:20,padding:"18px 8px",cursor:"pointer",fontFamily:"inherit",display:"flex",flexDirection:"column",alignItems:"center",gap:8}}><DiceSvg size={38} color={C.orange}/><div style={{fontSize:13,fontWeight:700,color:C.orange}}>Random Chore</div></button><button type="button" onClick={()=>setSubScreen("addTask")} style={{flex:1,background:"#FDEEF1",border:"2.5px solid #F0A8B8",borderRadius:20,padding:"18px 8px",cursor:"pointer",fontFamily:"inherit",display:"flex",flexDirection:"column",alignItems:"center",gap:8}}><svg width="38" height="38" viewBox="0 0 24 24" fill="none" stroke={C.coral} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg><div style={{fontSize:13,fontWeight:700,color:C.coral}}>Add Task</div></button></div></div></div>);
}
...
function ProgressScreen({tasks,completedChores,setSubScreen}){
  ...
  const weekDays=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];const barH=[70,85,50,60,40,20,10];const barV=[7,9,5,6,4,2,1];const barC=[C.orange,C.yellow,C.coral,C.teal,C.blue,C.orange,C.yellow];
  const[activeBar,setActiveBar]=useState(null);
  const cats=[{label:"Daily Tasks",done,total,color:C.orange},{label:"Weekly Tasks",done:3,total:8,color:C.yellow},{label:"Monthly Tasks",done:1,total:4,color:C.coral},{label:"Random Chores",done:completedChores.length,total:Math.max(completedChores.length,12),color:C.teal}];
  const rooms=ROOMS.filter(r=>tasks.some(t=>t.room===r));
  const allDates=new Set([...tasks.filter(t=>t.completed).map(()=>TODAY),...completedChores.map(c=>c.completedDate)]);
  let streak=0;for(let i=0;i<365;i++){const d=new Date(Date.now()-i*86400000).toISOString().split("T")[0];if(allDates.has(d))streak++;else break;}
